...
//        }
        ...
        System.out.println(cart1.hashCode()); //817978763
        System.out.println(cart2.hashCode()); //1578009262
        //hashCode를 확인해봐도 두 카트가 다른 객체Instance로 인식되고 있음을 볼 수 있음

        /*Spring Frameworkd에서 Bean의 prototype 스코프는 
        Bean 어플리케이션 내에서 bean이 불러와질 때마다 매번 새로운 인스턴스를 갖는다.
